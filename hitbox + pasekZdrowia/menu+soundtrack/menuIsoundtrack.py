...
# Tutaj podaj ścieżkę do pliku dźwiękowego
soundtrack_file_path = "C:\\Users\\adasf\\OneDrive\\Pulpit\\github\\NPGprojekt\\hitbox + pasekZdrowia\\menu+soundtrack\\sounds\\486-front-music.pl.mp3"

# Odtwarzaj ścieżkę dźwiękową w pętli
play_music(soundtrack_file_path)
