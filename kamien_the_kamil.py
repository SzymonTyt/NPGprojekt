...
pygame.mixer.music.load('game_.mp3')
...
bug_wrog = Wrog((255, 0, 0), "bug", bug_x_rand, bug_y_rand, bug_x_size, bug_y_size, "data/animations/ant_move/1.png")
bug_wrog_2 = Wrog((255, 0, 0), "bug_2", bug_x_rand_2, bug_y_rand_2, bug_x_size_2, bug_y_size_2, "data/animations/spider_move/1.png")
bug_wrog_3 = Wrog((255, 0, 0), "bug_3", bug_x_rand_3, bug_y_rand_3, bug_x_size_3, bug_y_size_3, "data/animations/fly_move/1.png")
...
ant_death = []
for i in range(1, 21):
    ant_death.append(pygame.transform.scale(pygame.image.load("data/animations/ant_death/" + str(math.ceil(i/3)) + ".png"),(1.1 * bug_x_size, 1.1 * bug_y_size)))

#animacja fly_move
fly_move = []
for i in range(1, 8):
    fly_move.append(pygame.transform.scale(pygame.image.load("data/animations/fly_move/" + str(math.ceil(i/2)) + ".png"),(1.5 * bug_x_size_3, 1.5 * bug_y_size_3)))

#animacja fly_death
fly_death = []
for i in range(1, 22):
    fly_death.append(pygame.transform.scale(pygame.image.load("data/animations/fly_death/" + str(math.ceil(i/2)) + ".png"),(1.5 * bug_x_size_3, 1.5 * bug_y_size_3)))

#animacja spider_move
spider_move = []
for i in range(1, 12):
    spider_move.append(pygame.transform.scale(pygame.image.load("data/animations/spider_move/" + str(math.ceil(i/2)) + ".png"),(1.5 * bug_x_size_2, 1.5 * bug_y_size_2)))

#animacja spider_death
spider_death = []
for i in range(1, 20):
    spider_death.append(pygame.transform.scale(pygame.image.load("data/animations/spider_death/" + str(math.ceil(i/2)) + ".png"),(1.5 * bug_x_size_2, 1.5 * bug_y_size_2)))

#animacja spider_missile
spider_missile = []
for i in range(1, 16):
    spider_missile.append(pygame.transform.scale(pygame.image.load("data/animations/spider_missile/" + str(math.ceil(i/4)) + ".png"),(2.5 * bullet_r_2, 2.5 * bullet_r_2)))

#animacja spider_attack
spider_attack = []
for i in range(1, 14):
    spider_attack.append(pygame.transform.scale(pygame.image.load("data/animations/spider_attack/" + str(math.ceil(i/2)) + ".png"),(1.5 * bug_x_size_2, 1.5 * bug_y_size_2)))
...
while program_running:
    ...
    if not left and not right:
        rect_sword = pygame.Rect(player_pos.x + (7/8 * stone_x_size), player_pos.y + (1 * stone_y_size / 5), sword_x_size + 5, 0.9 * sword_y_size)
    elif not last_left:
        rect_sword = pygame.Rect(player_pos.x + (7/8 * stone_x_size), player_pos.y + (1 * stone_y_size / 5), sword_x_size + 5, 0.9 * sword_y_size)
    else:
        rect_sword = pygame.Rect(player_pos.x - (3/4 * stone_x_size) + 30, player_pos.y + (1 * stone_y_size / 5), sword_x_size + 5, 0.9 * sword_y_size)
    ...
    if money_existence:
        ...
        if pygame.Rect.colliderect(rect_stone, money_rect):
            ...
            stone_hp += 10
            money_existence = False
        if pygame.Rect.colliderect(money_rect, rect_bug) or pygame.Rect.colliderect(money_rect, rect_bug_2) or pygame.Rect.colliderect(money_rect, rect_bug_3):
            money_existence = False
    ...
    if money_existence_2:
        ...
        if pygame.Rect.colliderect(rect_stone, money_rect_2):
            ...
            stone_hp += 25
            money_existence_2 = False
        if pygame.Rect.colliderect(money_rect_2, rect_bug) or pygame.Rect.colliderect(money_rect_2, rect_bug_2) or pygame.Rect.colliderect(money_rect_2, rect_bug_3):
            money_existence_2 = False
    ...
    if money_existence_3:
        ...
        if pygame.Rect.colliderect(rect_stone, money_rect_3):
            ...
            stone_hp += 4
            money_existence_3 = False
        if pygame.Rect.colliderect(money_rect_3, rect_bug) or pygame.Rect.colliderect(money_rect_3, rect_bug_2) or pygame.Rect.colliderect(money_rect_3, rect_bug_3):
            money_existence_3 = False
