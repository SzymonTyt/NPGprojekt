...
while program_running:
    ...
    if bug_attack_2:
        pygame.draw.circle(screen, (255, 0, 0), (bullet_pos_2.x + bullet_r_2, bullet_pos_2.y + bullet_r_2), bullet_r_2)
    if bug_attack_3:
        pygame.draw.circle(screen, (255, 0, 0), (bullet_pos_3.x + bullet_r_3, bullet_pos_3.y + bullet_r_3), bullet_r_3)
