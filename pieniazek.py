...
while program_running:
    ...
    if player_pos.x <= distance:
        ...
        if screen_pos_x <= (-1/2 * width) - 20:
            ...
            bug_pos_2.x += (player_velocity - bug_v_start) * dt
            bug_pos_3.x += (player_velocity - bug_v_start) * dt
            if money_pos_x and money_pos_y:
    ...
    if player_pos.y <= distance*1.5:
        ...
        if screen_pos_y <= (-1/2 * height) - 20:
            ...
            bug_pos_2.y += (player_velocity - bug_v_start) * dt
            bug_pos_3.y += (player_velocity - bug_v_start) * dt
            if money_pos_x and money_pos_y:
    ...
    if bug_hp <= 0:
        ...
        money_pos_x = bug_pos.x
        money_pos_y = bug_pos.y
    ...
    if bug_hp_3 <= 0:
        ...
        money_pos_x_3 = bug_pos_3.x
        money_pos_y_3 = bug_pos_3.y
    ...
    if licznik_mrowek >= 8 and not bug_resp and not bug_resp_2 and not bug_resp_3:
